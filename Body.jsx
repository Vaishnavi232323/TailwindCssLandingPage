  ...
  return (
    <div className="space-y-4 lg:flex">
        <div className="flex items-center justify-center lg:flex-1 lg:order-2 lg:justify-end">
           ...
           <img src="./assets/Purple-Shape.svg" alt="3rd" className="absolute -rotate-[15deg] h-64 64 md:h-72 lg:h-[400px]" />
           <img src="./assets/Hero-Model.png" alt="hero" className="absolute h-64 64 md:h-72 lg:h-[400px]"/>
        </div>
        <div className="lg:flex-1 lg:order-1">
          <h1 className="text-5xl font-bold font-playfair leading-tight">Host your website in less than 5 minutes</h1>
          <p classname="font-lato text-gray-400">With Hotser, get your website up and running in no less than 5 minutes with the most compettetive pricing packages available online.</p>
          <form action="flex flex-col gap-4 md:flex-row">
